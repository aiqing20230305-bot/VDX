...
💬 你可以直接描述视频创意，或者先修正我的理解。`
  ...
  return (
    <div className="flex flex-col h-screen bg-[#0a0a0f] text-[#f5f5f7] relative overflow-hidden">
      ...
      <header className="relative flex-shrink-0 px-6 py-4 bg-[var(--bg-tertiary)] border-b border-white/10 flex items-center gap-4 z-10">
        ...
        <div className="ml-auto flex items-center gap-3">
          ...
          <button
            ...
            className="bg-[var(--bg-tertiary)]px-3 py-1.5 rounded-full flex items-center gap-2 hover:bg-white/8 hover:border-[var(--accent-border)] transition-smooth"
          >
          ...
          {/* 状态徽章 - Flat design */}
          <div className={`bg-[var(--bg-tertiary)] px-3 py-1.5 rounded-full flex items-center gap-2 transition-smooth ${
      ...
      <div className="relative flex-1 overflow-y-auto px-6 py-8 space-y-6">
        ...
        {isLoading && messages[messages.length - 1]?.role === 'user' && (
          <div className="flex gap-4 animate-fade-in">
            ...
            <div className="bg-[var(--bg-tertiary)]rounded-2xl rounded-tl-sm px-5 py-3 flex gap-3 items-center border border-white/10">
