...
> **最新版本 v1.0.20** (2026-04-13): Sentry配置现代化 ⚙️ - 迁移到instrumentation-client.ts，修复deprecation警告，添加路由导航追踪，确保Turbopack兼容性。保持 Lighthouse 100/100 满分，0 Critical漏洞，100%日志标准化。详见 [CHANGELOG.md](CHANGELOG.md)
...
| **v1.0.17** | **100** | **0.026** | **0.7s** | **~150KB** | ⭐ 视频预览+日志标准化 |
| **v1.0.18** | **100** | **0.026** | **0.7s** | **~150KB** | 设计系统深度优化 |
| **v1.0.19** | **100** | **0.026** | **0.7s** | **~150KB** | 🏆 零Critical漏洞+100%日志 |
| **v1.0.20** | **100** | **0.026** | **0.7s** | **~150KB** | ⚙️ Sentry配置现代化 |
